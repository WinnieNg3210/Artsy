...
review1 = Review.create!(content: "Beautiful, a nice touch to my living", rating: 5 , author_id: demoUser.id, product_id: product1.id)
...
# review3 = Review.create!(content: "", rating: 5 , author_id: user3.id, product_id: product2.id)
# review4 = Review.create!(content: "", rating: 5 , author_id: user4.id, product_id: product2.id)
# review5 = Review.create!(content: "", rating: 5 , author_id: user5.id, product_id: product3.id)
# review6 = Review.create!(content: "", rating: 5 , author_id: user6.id, product_id: product3.id)
# review7 = Review.create!(content: "", rating: 5 , author_id: user7.id, product_id: product4.id)
# review8 = Review.create!(content: "", rating: 5 , author_id: user8.id, product_id: product4.id)
# review9 = Review.create!(content: "", rating: 5 , author_id: user9.id, product_id: product5.id)
# review10 = Review.create!(content: "", rating: 5 , author_id: user10.id, product_id: product5.id)
# review11 = Review.create!(content: "", rating: 5 , author_id: user11.id, product_id: product6.id)
# review12 = Review.create!(content: "", rating: 5 , author_id: user1.id, product_id: product6.id)
# review13 = Review.create!(content: "", rating: 5 , author_id: user2.id, product_id: product7.id)
# review14 = Review.create!(content: "", rating: 5 , author_id: user3.id, product_id: product7.id)
# review15 = Review.create!(content: "", rating: 5 , author_id: user4.id, product_id: product8.id)
# review16 = Review.create!(content: "", rating: 5 , author_id: user5.id, product_id: product8.id)
# review17 = Review.create!(content: "", rating: 5 , author_id: user6.id, product_id: product9.id)
# review18 = Review.create!(content: "", rating: 5 , author_id: user7.id, product_id: product9.id)
# review19 = Review.create!(content: "", rating: 5 , author_id: user8.id, product_id: product10.id)
# review20 = Review.create!(content: "", rating: 5 , author_id: user9.id, product_id: product10.id)
# review21 = Review.create!(content: "", rating: 5 , author_id: user10.id, product_id: product11.id)
# review22 = Review.create!(content: "", rating: 5 , author_id: user11.id, product_id: product11.id)
# review23 = Review.create!(content: "", rating: 5 , author_id: user1.id, product_id: product12.id)
# review24 = Review.create!(content: "", rating: 5 , author_id: user2.id, product_id: product12.id)
# review25 = Review.create!(content: "", rating: 5 , author_id: user3.id, product_id: product13.id)
# review26 = Review.create!(content: "", rating: 5 , author_id: user4.id, product_id: product13.id)
# review27 = Review.create!(content: "", rating: 5 , author_id: user5.id, product_id: product14.id)
# review28 = Review.create!(content: "", rating: 5 , author_id: user6.id, product_id: product14.id)
# review29 = Review.create!(content: "", rating: 5 , author_id: user7.id, product_id: product15.id)
# review30 = Review.create!(content: "", rating: 5 , author_id: user8.id, product_id: product15.id)
# review31 = Review.create!(content: "", rating: 5 , author_id: user9.id, product_id: product16.id)
# review32 = Review.create!(content: "", rating: 5 , author_id: user10.id, product_id: product16.id)
# review33 = Review.create!(content: "", rating: 5 , author_id: user11.id, product_id: product17.id)
# review34 = Review.create!(content: "", rating: 5 , author_id: user1.id, product_id: product17.id)
# review35 = Review.create!(content: "", rating: 5 , author_id: user2.id, product_id: product18.id)
# review36 = Review.create!(content: "", rating: 5 , author_id: user3.id, product_id: product18.id)
# review37 = Review.create!(content: "", rating: 5 , author_id: user4.id, product_id: product19.id)
# review38 = Review.create!(content: "", rating: 5 , author_id: user5.id, product_id: product19.id)
# review39 = Review.create!(content: "", rating: 5 , author_id: user6.id, product_id: product20.id)
# review40 = Review.create!(content: "", rating: 5 , author_id: user7.id, product_id: product20.id)
# review41 = Review.create!(content: "", rating: 5 , author_id: user8.id, product_id: product21.id)
# review42 = Review.create!(content: "", rating: 5 , author_id: user9.id, product_id: product21.id)
# review43 = Review.create!(content: "", rating: 5 , author_id: user10.id, product_id: produc22.id)
# review44 = Review.create!(content: "", rating: 5 , author_id: user11.id, product_id: product22.id)
# review45 = Review.create!(content: "", rating: 5 , author_id: user1.id, product_id: product23.id)
# review46 = Review.create!(content: "", rating: 5 , author_id: user2.id, product_id: product23.id)
# review47 = Review.create!(content: "", rating: 5 , author_id: user3.id, product_id: product24.id)
# review48 = Review.create!(content: "", rating: 5 , author_id: user4.id, product_id: product24.id)